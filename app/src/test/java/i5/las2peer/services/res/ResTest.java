...
public class ResTest {
  ...
  public void testNewTestCase2() {
    ...
    try {
      ...
      JSONObject object352191 = (JSONObject) response;
      // Assert that field x exists
      Assert.assertTrue(object352191.containsKey("x"));
      Object object352191_2 = object352191.get("x");
      // Require object352191_2 to be a JSONObject
      Assert.assertTrue(object352191_2 instanceof JSONObject);
      // Cast object352191_2 to JSONObject
      JSONObject object232041 = (JSONObject) object352191_2;
      // Assert that field y exists
      Assert.assertTrue(object232041.containsKey("y"));
      Object object232041_2 = object232041.get("y");
      Assert.assertTrue(object232041_2 instanceof JSONObject);
      Assert.assertTrue("Status code equals 200 [152287]", result.getHttpCode() == 200);
